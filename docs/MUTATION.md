...
| M64 | `harness/hooks.py` | the guard reads one line at a time, and cuts every multi-line quote | 2 — `HookTest.test_pre_bash_allows_a_command_that_a_line_reader_cannot_lex`, `HookTest.test_pre_bash_denies_history_changes_with_reordered_git_flags` |
